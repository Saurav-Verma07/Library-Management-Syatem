  ...
  return <>
    ...
    <div className="w-full md:w-1/2 flex flex-col justify-center items-center bg-white-100 p-8">
     <div className="max-w-sm w-full">
      ...
      <h1 className="text-4xl font-medium text-center md-12 overflow-hidden">Welcome Back !!</h1>
...
<div className="block md:hidden fonr-semibold mt-5">
  <p>New User ? <Link to={"/register"} className="text-sm text-gray-500 hover:underline">Sign Up</Link></p>
</div>
    ...
    <div className="hidden w-full md:w-1/2 bg-black text-white md:flex flex-col items-center justify-center p-8 rounded-tl-[80px rounded-bl-[80px]">
      <div className="text-center h-[400px]">
        <div className="flex justify-center mb-12">
          <img src={libsystem} alt="logo" className="mb-12 h-44 w-auto  " />
        </div>
