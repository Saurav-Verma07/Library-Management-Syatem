...
const AddBookPopup = () => {
  ...
  return <>
    <div className="fixed inset-0 bg-black bg-opacity-50 p-5 flex items-center justify-center z-50">
        ...
        <div className='p-6 '>
          ...
          <form onSubmit={handleAddBook}>
            <div className='mb-4'>
              <label className='block text-gray-900 font-medium '>Book Ttile</label>
   ...
   <div className='mb-4'>
              <label className='block text-gray-900 font-medium '>Book Discription</label>
              <textarea value={discription} onChange={(e)=>setDiscription(e.target.value)} placeholder="Book's Discription"rows={4} className="w-full px-4 py-2 border-2 border-black rounded-md "
              />
              
            </div>
           <div className='flex justify-end space-x-4'>
              <button className='px-4 py-2 bg-gray-200 rounded-md hover:gb-gray-300' type='button' onClick={()=>{
