  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 p-5 flex items-center justify-center z-50">
      ...
      <div className="flex justify-between items-center bg-black text-white px-6 py-4 rounded-t-lg"> 
        ...
        <button className='text-white text-lg font-bold' onClick={()=>dispatch(toggleReadBookPopup())} >&times;
      ...
      <div className="p-6">
        ...
        <div className='mb-4'>
          <label className='block text-gray-700 font-semibold'>Book Author</label>
        <p className='border border-gray-300 rounded-lg px-4 py-2 bg-gray-100'>{book && book.author}</p>
        </div>
        <div className='mb-4'>
          <label className='block text-gray-700 font-semibold'>Book Discription</label>
        <p className='border border-gray-300 rounded-lg px-4 py-2 bg-gray-100'>{book && book.discription}
