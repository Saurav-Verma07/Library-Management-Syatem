    ...
    <>
      <main className="relative flex-1 p-6 pt-28">
        ...
        <div className="flex flex-col-reverse xl:flex-row">
          {/* LEFT SIDE */}
          <div className="flex flex-[4] flex-col gap-7 lg:gap-7 lg:py-5 justify-between xl:min-h-[75.5vh]">
            <div className="flex flex-col gap-7 flex-[4]">
              <div className="flex flex-col lg:flow-row gap-7 overflow-y-hidden">
                ...
                <div className="flex items-center gap-3 bg-white p-5 min-h-[120px] overflow-y-hidden rounded-lg transition hover:shadow-inner duration-300">
                  ...
                  <p className="text-lg xl:text-xl font-semibold">
                    Your Borrow Book List
                  </p>
                </div>

                {/* Returned Book */}
                <div className="flex items-center gap-3 bg-white p-5 min-h-[120px] flex-shrink-0 rounded-lg transition-shadow hover:shadow-inner duration-300">
                  <span className="w-[2px] bg-black self-stretch"></span>

                  <span className="bg-gray-300 h-20 min-w-[80px] flex justify-center items-center rounded-lg">
                    <img
                      src={returnIcon}
                      alt="return-icon"
                      className="w-8 h-8"
              ...
              <div className="flex flex-col lg:flex-row gap-7">
                <div className="flex items-center gap-3 bg-white p-5 max-h-[120px] overflow-y-hidden rounded-lg transition hover:shadow-inner duration-300">
                  ...
                  <span className="bg-gray-300 h-28 lg:h-full min-w-28 flex justify-center items-center rounded-lg">
                    <img
                      src={browseIcon}
                      alt="browse-icon"
                      className="w-8 h-8"
                ...
                <img
                  src={logo_with_title}
                  alt="logo"
                  className=" lg-block w-auto justify-end"
                />
              </div>
            </div>
            <div className="bg-white p-7 text-lg sm:text-xl xl:text-3xl 2xl:text-4xl min-h-52 font-semibold relative flex-[3] flex justify-center items-center rounded-2xl ">
              <h4 className="overflow-y-hidden">
                ...
                nurturing a path towards excellence and the
          ...
          <div className="flex-[2] flex-col gap-7 lg:flex-row flex lg:items-center xl:flex-col justify-between xl:gap-20 py-5">
            ...
            <div className="flex items-center p-8 w-full sm:w-[400px] xl:w-fit mr-5 xl:p-6 gap-5 h-fit xl:min-h-[150px] bg-white xl:flex-1 rounded-lg">
